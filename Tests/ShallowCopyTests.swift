...
final class ShallowCopyTests: TestBase {
    ...
    func testRoutineWithExercise() throws {
        ...
        let ds: ZExercise? = try ZExercise.get(testContext, routineArchiveID: routineArchiveID, exerciseArchiveID: exerciseArchiveID, inStore: archiveStore)
        XCTAssertNotNil(ds)
    ...
    func testRoutineWithExerciseAndExerciseRun() throws {
        ...
        try testContext.save()
        guard let de = try ZExercise.get(testContext, routineArchiveID: routineArchiveID, exerciseArchiveID: exerciseArchiveID, inStore: archiveStore)
        else { XCTFail(); return }
